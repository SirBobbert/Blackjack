public class UI {
    ...
    // ===== Logs / status =====
    public void info(String msg)    { log("INFO","36", msg); }
    public void warn(String msg)    { log("WARN","33", msg); }
    public void success(String msg) { log("OK","32",   msg); }
    public void error(String msg)   { log("ERR","31",  msg); }
    ...
    public void menu(String title, String... options) {
        ...
        for (int i = 0; i < options.length; i++) {
            ...
            if (colorEnabled) { num = ansi("36", num); key = ansi("90", key); }
